...
# Load data from CSV files
X_data = pd.read_csv('X_data.csv')  # Assuming X_data.csv contains 'Weight,' 'Age,' 'Virion Count,' and 'Gender'
Y_data = pd.read_csv('Y_data.csv')  # Assuming Y_data.csv contains 'Severity'

# Convert Y_data to a 1D array
...
# Define parameter values for prediction
virioncount = 0  # Replace with the actual virioncount value
weight = 0.1         # Replace with the actual weight value
age = 1            # Replace with the actual age value
gender = 0       # Replace with the actual gender value
